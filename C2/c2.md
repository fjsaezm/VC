...
Las alternativas son diversas, mencionamos algunas de las más importantes:
...
- Añadir capas de normalización, como bien podría ser *Batch Normalization*

- Añadir normalizaciones como $L_1$ ó $L_2$
...
Esta ayuda al aprendizaje de la red, aportando la no linealidad a los modelos que se definen. Además, ayuda también a la optimización pues ayuda a solucionar el problema de los gradientes desvanecientes.
...
Podríamos decir que las aproximaciones clásicas son múltiples, ponemos como ejemplo *sliding window* y *HOG*. En ellos se trabaja con regiones pequeñas de las imágenes y por tanto perdemos generalidad en el proceso.
*
Las aproximaciones clásicas tienen diversos problemas como:

- Un *template* a veces no representa una categoría completa
- Muchos objetos pueden verse de manera diferente según la posición o siendo distintos pero del mismo tipo de objeto

Estos modelos se han mejorado mediante las CNN con procesos como:
